...
[^8]: Shilts *And the Band Played On*. (). France *How to Survive a
    Plague.* ()
...
[^9]: This section is based on information from Shilts *And the Band
    Played On.* () and Epstein, *Impure Science.* ().
...
[^10]: For more information on the conservative swing leading into the
    ...
    University Press, 2008). () and Douglas C Rossinow, *The Reagan Era:
    A History of the 1980s* (New York: Columbia University Press, 2017)
    ().
...
[^11]: Jennifer Brier, *Infectious Ideas: U.S. Political Responses to
    ...
    Press, 2009). (). Alexandra Lord, *Condom Nation: The U.S.
    Government’s Sex Education Campaign from World War I to the
    Internet* (Johns Hopkins University Press, 2010). ().
...
[^12]: Shilts *And the Band Played On.* ().
...
[^14]: Shilts *And the Band Played On.* ().
